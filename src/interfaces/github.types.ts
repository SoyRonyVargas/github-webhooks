export interface GihubStarPayload {
    action:     string;
    starred_at: null;
...
export class Convert {
    public static toGihubStar(json: string): GihubStarPayload {
        return cast(JSON.parse(json), r("GihubStar"));
    }

    public static gihubStarToJson(value: GihubStarPayload): string {
        return JSON.stringify(uncast(value, r("GihubStar")), null, 2);
    }
}
...
const typeMap: any = {
    "GihubStar": o([
        ...
        { json: "starred_at", js: "starred_at", typ: null },
    ...
    "Repository": o([
        ...
        { json: "owner", js: "owner", typ: r("Sender") },
